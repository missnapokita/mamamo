(function(){
  ...
  function hideOverlay(){
    ...
    /*
     * A cross-origin iframe consumes its own taps, so they cannot wake the
     * parent Bidamax controls. While our controls are hidden, temporarily
     * disable iframe hit-testing. The next tap reaches #player instead.
     *
     * No extra overlay/z-index layer is used, so loading/error/quality UI
     * cannot be covered by this fix.
     */
  ...
  function showOverlay(){
    ...
    // Controls are visible again, so return normal interaction to the video.
    frame.style.pointerEvents="auto";
